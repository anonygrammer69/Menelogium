      ...
      for (let i = 0; i < 7; i++) {
        ...
        week.push(
          <div
            ...
            className={`flex p-4 justify-evenly border-2 border-black rounded-sm w-20 h-16 font-sans hover:shadow-xl hover:shadow-gray-600  hover:bg-gray-400  transition duration-200${!isSameMonth(day, currentMonth) ? "text-gray-400" : ""} ${
