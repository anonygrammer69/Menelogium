...
const Calendar: React.FC = () => {
  ...
  const renderDays = () => {
    ...
    while (day <= endDate) {
      ...
      for (let i = 0; i < 7; i++) {
        ...
        week.push(
          <div
            ...
            className={`flex p-4 justify-evenly border-2 border-black rounded-sm w-20 h-16 font-sans hover:shadow-xl hover:shadow-gray-600  hover:bg-gray-300  transition duration-200${!isSameMonth(day, currentMonth) ? "text-gray-400" : ""} ${
      ...
      days.push(<div className="flex lg:flex-auto shadow-2xl flex-auto p-5 justify-evenly bg-slate-400 hover:bg-gray-300 transition duration-300
