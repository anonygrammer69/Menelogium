...
const Calendar: React.FC = () => {
  ...
  const renderDays = () => {
    ...
    while (day <= endDate) {
      ...
      days.push(<div className="flex flex-auto p-5 justify-evenly bg-yellow-600
         text-black border-3 rounded-lg border-black w-170 h-full position: relative" key={day.toString()}>{week}</div>);
    }
