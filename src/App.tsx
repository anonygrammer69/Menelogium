...
function App() {
  ...
  return (
    <>
      ...
      <h1 className="flex text-base justify-center ml-20 mt-10 sm:mt-10 md:mt-10 md:ml-10 underline font-semibold md:font-semibold text-gray-800">Welcome to your Calendar</h1>
      <div>
        <a>
