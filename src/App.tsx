...
function App() {
  ...
  return (
    <>
      ...
      <div>
        <a>
          <img src={CALENDAR} className="flex bg-gradient-to-b h-20 justify-center ml-70 lg:ml-125 my-6 hover:shadow-2xl hover:shadow-amber-700 transition duration-300 ease-in-out"/>
        </a>
      </div>
      <div>
        <p>
