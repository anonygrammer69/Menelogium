...
function App() {
  ...
  return (
    <>
      ...
      <h1 className="flex flex-col text-base justify-center mt-10 sm:mt-10 md:mt-10 md:ml-10 underline font-semibold md:font-semibold text-gray-800">Welcome to your Calendar</h1>
      <div>
        <a>
