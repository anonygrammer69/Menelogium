...
function App() {
  ...
  return (
    <>
      ...
      <h1 className="flex text-base justify-center ml-16 mt-10 md:ml-10 font-sans text-gray-800">Welcome to your Calendar</h1>
      <div>
        <a>
          <img src={CALENDAR} className="flex flex-auto h-20 justify-center sm:ml-75 md:ml-90 lg:ml-120 my-6"/>
        </a>
      </div>
      <div>
        <p>
