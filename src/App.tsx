...
function App() {
  ...
  return (
    <>
      ...
      <h1 className="flex text-base left-5 justify-center mt-10 sm:mt-10 md:mt-10 md:ml-10 underline font-semibold md:font-semibold text-gray-800">Welcome to your Calendar</h1>
      <div>
        <a>
