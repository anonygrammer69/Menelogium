...
function App() {
  ...
  return (
    <>
      ...
      <div>
        <a>
          <img src={CALENDAR} className="flex flex-row h-20 justify-center ml-50 mb-2 mt-2 hover:shadow-2xl hover:shadow-amber-500 transition duration-300 ease-in-out"/>
        </a>
      </div>
      <div>
        <p>
