...
const Chatbot: React.FC = () => {
  ...
  return (
    <>
      {/* Chat Window */}
      <div
        className={`fixed bottom-20 right-6 w-80 h-96 bg-white border-2 border-gray-300 rounded-lg shadow-2xl transition-all duration-300 ease-in-out z-50 ${
        ...
        <div className="h-64 overflow-y-auto p-3 bg-gray-50">
          ...
          {isLoading && (
            <div className="flex justify-start mb-3">
              <div className="bg-white border border-gray-200 text-gray-800 rounded-lg rounded-bl-none px-3 py-2 text-sm">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center"
      >
        {isOpen ? (
