  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 text-white rounded-full justify-center hover:bg-gray-800 hover:shadow-2xl transition-all duration-300 z-40 flex border-4 border-white"
      >
        {isOpen ? (
